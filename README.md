...
<h4>УСТАНОВКА</h4>
Запустите первые ячейки проекта на colab. Для запуска бота скачать папку rare_tg_bot, установить библиотеки из requirements.txt и запустить файл с названием path_bot.py
